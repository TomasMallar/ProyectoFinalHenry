  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <button className="py-2.5 px-5 my-2 bg-chocolate-oscuro text-chocolate-blanco border-none rounded text-base mr-2.5 mt-2.5 hover:bg-chocolate-bombom hover:shadow-xl " variant="contained" color="primary" value={params.row.id} onClick={handleButtonClickDetail}>
            Ver
          </button>
        );
      },
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <button className="py-2.5 px-5 my-2 bg-red text-chocolate-blanco border-none rounded text-base mr-2.5 mt-2.5 hover:bg-LightRed hover:shadow-xl " variant="contained" color="primary" value={params.row.id} onClick={handleButtonClickDelete}>
            Eliminar
          </button>
        );
      },
