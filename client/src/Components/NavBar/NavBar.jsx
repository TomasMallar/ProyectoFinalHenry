        ...
        <div className="sticky top-0 z-10 flex justify-between w-full shadow-md bg-chocolate-mantecol">
            ...
            <ul className="flex p-2.5 items-center justify-center">
                ...
                <Link to="/login" className="text-2xl list-none text-chocolate-oscuro no-underline pl-3.5  font-serif ">
                    <li>
                        <button className="flex items-center justify-between p-4 font-serif text-xl border-none shadow rounded-xl text-chocolate-blanco bg-chocolate-oscuro hover:shadow-xl shadow-chocolate-oscuro"> Logout
                            <img src="https://HomePagereferences.my.canva.site/images/3be2725b25654ed759a755525de91b77.svg" alt="" className="w-5 ml-2.5" />
                        </button>
                    </li>
                </Link>
            </ul>
