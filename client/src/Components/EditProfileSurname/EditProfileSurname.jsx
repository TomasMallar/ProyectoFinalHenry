        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col items-center pt-12 ">
            ...
            <div>
              ...
              <Link to='/myprofile' className="p-1.5 m-2 font-serif font-bold rounded-lg shadow-sm bg-chocolate-oscuro text-chocolate-blanco shadow-chocolate-claro hover:bg-chocolate-bombom">
                Cancelar
              </Link>
            </div>
          </div>
