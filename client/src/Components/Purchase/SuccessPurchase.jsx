  ...
  return (
    <div className="h-screen p-12 font-serif text-chocolate-oscuro bg-chocolate-blanco">
      <div className='p-6 rounded-2xl'>
        ...
        <button className="p-4 text-xl font-bold shadow-sm h-fit shadow-chocolate-claro bg-chocolate-claro rounded-xl text-chocolate-oscuro hover:bg-chocolate-mantecol">
